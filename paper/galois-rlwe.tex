...
%\authorrunning{Attacks on Search RLWE}
...
% Then we analyze the security of cyclotomic fields against our attack.

%Also, we sharpen the attack in \cite{elos2015weak} and give examples of vulnerable instances of cryptographic size. Finally, we discuss the effect of modulus switching on our attacks.
\end{abstract}
...
This file contains the object needed for manipulating subgroups $H$ of $(\bZ/m\bZ)^*$.
...
\scriptsize
\begin{verbatim}
print 'We peform the full attack on an Galois instance.'
